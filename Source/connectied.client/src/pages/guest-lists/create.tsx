...
export default function CreateGuestListPage() {
    ...
    async function onSubmit(data: z.infer<typeof FormSchema>) {
        ...
        try {
            ...
            const id = await client.createGuestList(payload)

            if (!id) throw new Error("No guest list ID returned")

            toast.success("Guest List Created")
            console.log("Navigating to", `/guest-lists/details/${String(id)}`)
    ...
    return (
        <div className="max-w-4xl space-y-4">
            <TypographyH1>Create Guest List</TypographyH1>
            <Form {...form}>
